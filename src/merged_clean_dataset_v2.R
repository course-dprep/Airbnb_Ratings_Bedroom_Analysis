...
listings_selected<- left_join(listings_selected, avgprice_by_neighbourhood, by = c("neighbourhood_cleansed" = "neighbourhood_cleansed"), suffix= c("neighbourhood","neigbouravgeprice"))
